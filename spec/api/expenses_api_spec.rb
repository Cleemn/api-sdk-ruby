...
# Unit tests for SwaggerClient::ExpensesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExpensesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ExpensesApi.new
  end
  ...
  describe 'test an instance of ExpensesApi' do
    it 'should create an instance of ExpensesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ExpensesApi)
    end
  end

  # unit tests for get_api_v3_expenses
  ...
  describe 'get_api_v3_expenses test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_api_v3_expenses_id
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [Expense]
  describe 'get_api_v3_expenses_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
