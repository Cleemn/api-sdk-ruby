...
# Unit tests for SwaggerClient::AnalyticCodesApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnalyticCodesApi' do
  before do
    # run before each test
    @instance = SwaggerClient::AnalyticCodesApi.new
  end
  ...
  describe 'test an instance of AnalyticCodesApi' do
    it 'should create an instance of AnalyticCodesApi' do
      expect(@instance).to be_instance_of(SwaggerClient::AnalyticCodesApi)
    end
  end

  # unit tests for delete_api_v3_analytic_codes_id
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_api_v3_analytic_codes_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_api_v3_analytic_codes
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_api_v3_analytic_codes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_api_v3_analytic_codes_id
  # @param id 
  # @param [Hash] opts the optional parameters
  # @return [AnalyticCode]
  describe 'get_api_v3_analytic_codes_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for post_api_v3_analytic_codes
  # @param analytic_code 
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'post_api_v3_analytic_codes test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for put_api_v3_analytic_codes_id
  # @param id 
  # @param analytic_codes_body 
  # @param [Hash] opts the optional parameters
  # @return [AnalyticCode]
  describe 'put_api_v3_analytic_codes_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
