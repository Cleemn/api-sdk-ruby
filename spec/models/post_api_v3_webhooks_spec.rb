...
# Unit tests for SwaggerClient::PostApiV3Webhooks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostApiV3Webhooks' do
  before do
    # run before each test
    @instance = SwaggerClient::PostApiV3Webhooks.new
  end
  ...
  describe 'test an instance of PostApiV3Webhooks' do
    it 'should create an instance of PostApiV3Webhooks' do
      expect(@instance).to be_instance_of(SwaggerClient::PostApiV3Webhooks)
    end
  end
