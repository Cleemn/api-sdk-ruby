...
# Unit tests for SwaggerClient::PostApiV3ExpenseCategoriesExpenseCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostApiV3ExpenseCategoriesExpenseCategory' do
  before do
    # run before each test
    @instance = SwaggerClient::PostApiV3ExpenseCategoriesExpenseCategory.new
  end
  ...
  describe 'test an instance of PostApiV3ExpenseCategoriesExpenseCategory' do
    it 'should create an instance of PostApiV3ExpenseCategoriesExpenseCategory' do
      expect(@instance).to be_instance_of(SwaggerClient::PostApiV3ExpenseCategoriesExpenseCategory)
    end
  end
