...
# Unit tests for SwaggerClient::PutApiV3ExpenseCategoriesExpenseCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PutApiV3ExpenseCategoriesExpenseCategory' do
  before do
    # run before each test
    @instance = SwaggerClient::PutApiV3ExpenseCategoriesExpenseCategory.new
  end
  ...
  describe 'test an instance of PutApiV3ExpenseCategoriesExpenseCategory' do
    it 'should create an instance of PutApiV3ExpenseCategoriesExpenseCategory' do
      expect(@instance).to be_instance_of(SwaggerClient::PutApiV3ExpenseCategoriesExpenseCategory)
    end
  end
