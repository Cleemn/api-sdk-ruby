...
# Unit tests for SwaggerClient::PostApiV3AnalyticCodes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostApiV3AnalyticCodes' do
  before do
    # run before each test
    @instance = SwaggerClient::PostApiV3AnalyticCodes.new
  end
  ...
  describe 'test an instance of PostApiV3AnalyticCodes' do
    it 'should create an instance of PostApiV3AnalyticCodes' do
      expect(@instance).to be_instance_of(SwaggerClient::PostApiV3AnalyticCodes)
    end
  end
