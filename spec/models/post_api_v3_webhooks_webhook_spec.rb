...
# Unit tests for SwaggerClient::PostApiV3WebhooksWebhook
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostApiV3WebhooksWebhook' do
  before do
    # run before each test
    @instance = SwaggerClient::PostApiV3WebhooksWebhook.new
  end
  ...
  describe 'test an instance of PostApiV3WebhooksWebhook' do
    it 'should create an instance of PostApiV3WebhooksWebhook' do
      expect(@instance).to be_instance_of(SwaggerClient::PostApiV3WebhooksWebhook)
    end
  end
