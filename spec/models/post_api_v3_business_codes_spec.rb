...
# Unit tests for Mooncard::PostApiV3BusinessCodes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostApiV3BusinessCodes' do
  before do
    # run before each test
    @instance = Mooncard::PostApiV3BusinessCodes.new
  end
  ...
  describe 'test an instance of PostApiV3BusinessCodes' do
    it 'should create an instance of PostApiV3BusinessCodes' do
      expect(@instance).to be_instance_of(Mooncard::PostApiV3BusinessCodes)
    end
  end
