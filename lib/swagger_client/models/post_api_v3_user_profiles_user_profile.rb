...
module SwaggerClient
  class PostApiV3UserProfilesUserProfile
    ...
    def hash
      [position, confirmed_at, active, analytic_code, code, accounting_employee_account, accounting_charge_account, two_factor_active, expense_type, status, email, firstname, lastname, role, phone, address, birthdate, locale].hash
    end
