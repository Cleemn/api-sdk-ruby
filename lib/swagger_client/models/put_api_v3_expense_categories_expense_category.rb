...
module SwaggerClient
  class PutApiV3ExpenseCategoriesExpenseCategory
    ...
    def hash
      [analytic_codes, asset_accounting, business_codes, charge_account, deductible_vat, description, expense_category_template, expense_type, goods_or_services, group, guests, name, no_receipts, rebilling, supplier_account].hash
    end
