...
module SwaggerClient
  class PutApiV3UserProfilesUserProfile
    ...
    def hash
      [position, confirmed_at, archived_at, active, analytic_code, code, accounting_employee_account, accounting_charge_account, two_factor_active, role, expense_type, status, phone, address, email, firstname, lastname, birthdate, locale].hash
    end
