...
module SwaggerClient
  class ExpensesApi
    ...
    def get_api_v3_expenses(opts = {})
      data, _status_code, _headers = get_api_v3_expenses_with_http_info(opts)
      data
    end
    ...
    def get_api_v3_expenses_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExpensesApi.get_api_v3_expenses ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExpensesApi#get_api_v3_expenses\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Expense]
    def get_api_v3_expenses_id(id, opts = {})
      data, _status_code, _headers = get_api_v3_expenses_id_with_http_info(id, opts)
      data
    end
    ...
    def get_api_v3_expenses_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ExpensesApi.get_api_v3_expenses_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ExpensesApi.get_api_v3_expenses_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Expense')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ExpensesApi#get_api_v3_expenses_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
