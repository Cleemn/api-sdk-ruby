...
module SwaggerClient
  class AccountMovementsApi
    ...
    def get_api_v3_account_movements(account_id, opts = {})
      data, _status_code, _headers = get_api_v3_account_movements_with_http_info(account_id, opts)
      data
    end
    ...
    def get_api_v3_account_movements_with_http_info(account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountMovementsApi.get_api_v3_account_movements ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling AccountMovementsApi.get_api_v3_account_movements"
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountMovementsApi#get_api_v3_account_movements\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def get_api_v3_account_movements_id(id, opts = {})
      get_api_v3_account_movements_id_with_http_info(id, opts)
      nil
    end
    ...
    def get_api_v3_account_movements_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountMovementsApi.get_api_v3_account_movements_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling AccountMovementsApi.get_api_v3_account_movements_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountMovementsApi#get_api_v3_account_movements_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
