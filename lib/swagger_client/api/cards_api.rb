...
module SwaggerClient
  class CardsApi
    ...
    # @return [Array<Card>]
    def get_api_v3_cards(opts = {})
      data, _status_code, _headers = get_api_v3_cards_with_http_info(opts)
      data
    end
    ...
    def get_api_v3_cards_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.get_api_v3_cards ...'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#get_api_v3_cards\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Card]
    def get_api_v3_cards_id(id, opts = {})
      data, _status_code, _headers = get_api_v3_cards_id_with_http_info(id, opts)
      data
    end
    ...
    def get_api_v3_cards_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.get_api_v3_cards_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CardsApi.get_api_v3_cards_id"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Card')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#get_api_v3_cards_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    # @param id 
    ...
    # @param [Hash] opts the optional parameters
    # @return [Card]
    def put_api_v3_cards_id(id, card, opts = {})
      data, _status_code, _headers = put_api_v3_cards_id_with_http_info(id, card, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Card, Fixnum, Hash)>] Card data, response status code and response headers
    def put_api_v3_cards_id_with_http_info(id, card, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.put_api_v3_cards_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CardsApi.put_api_v3_cards_id"
      end
      # verify the required parameter 'card' is set
      if @api_client.config.client_side_validation && card.nil?
        fail ArgumentError, "Missing the required parameter 'card' when calling CardsApi.put_api_v3_cards_id"
      end
      # resource path
      local_var_path = '/api/v3/cards/{id}'.sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'Card')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#put_api_v3_cards_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
