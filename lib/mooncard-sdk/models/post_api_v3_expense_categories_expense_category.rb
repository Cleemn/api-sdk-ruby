...
module Mooncard
  class PostApiV3ExpenseCategoriesExpenseCategory
    ...
    def list_invalid_properties
      ...
      if @charge_account.nil?
        invalid_properties.push('invalid value for "charge_account", charge_account cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @charge_account.nil?
    ...
    def hash
      [analytic_codes, asset_accounting, business_codes, deductible_vat, description, expense_category_template, expense_type, goods_or_services, group, guests, no_receipts, rebilling, supplier_account, charge_account, name].hash
    end
