...
module Mooncard
  class ExpenseCategory
    ...
    def hash
      [id, analytic_codes, asset_accounting, business_codes, charge_account, created_at, deductible_vat, description, expense_category_template, expense_type, goods_or_services, group, guests, name, no_receipts, rebilling, supplier_account, updated_at, archived_at].hash
    end
