...
module Mooncard
  class PostApiV3AnalyticCodes
    ...
    def self.swagger_types
      {
        :'analytic_code' => :'PostApiV3AnalyticCodesAnalyticCode'
      }
    end
    ...
    def list_invalid_properties
      ...
      if @analytic_code.nil?
        invalid_properties.push('invalid value for "analytic_code", analytic_code cannot be nil.')
      end
    ...
    def valid?
      return false if @analytic_code.nil?
      true
    end
