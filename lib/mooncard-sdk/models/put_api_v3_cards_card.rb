...
module Mooncard
  class PutApiV3CardsCard
    ...
    attr_accessor :allow_mccs_car_park

    # Enables payments for taxi and black car services
    attr_accessor :allow_mccs_taxi

    # Enables payments for health and pharmacy
    attr_accessor :allow_mccs_medical

    # Enables payments for plane tickets
    attr_accessor :allow_mccs_airplane

    # Enables payments for car rentals
    attr_accessor :allow_mccs_car_rental

    # Enables payments in hotels
    attr_accessor :allow_mccs_travel

    # Enables payments in restaurants
    attr_accessor :allow_mccs_food

    # Enables payments for delivery services
    attr_accessor :allow_mccs_courier

    # Enables payments of fines and car pounds
    attr_accessor :allow_mccs_car_pound

    # Enables payments in autoshops, towing
    attr_accessor :allow_mccs_car_repairs

    # Enables payments for hardware and furnitures
    attr_accessor :allow_mccs_hardware

    # Enables payments for marketing and advertising
    attr_accessor :allow_mccs_advertising

    # Enables payments for subscriptions on the internet
    attr_accessor :allow_mccs_online_subscription

    # Enables miscellaneous payments
    attr_accessor :allow_mccs_misc
    ...
    def self.attribute_map
      {
        ...
        :'allow_mccs_car_park' => :'allow_mccs_car_park',
        :'allow_mccs_taxi' => :'allow_mccs_taxi',
        :'allow_mccs_medical' => :'allow_mccs_medical',
        :'allow_mccs_airplane' => :'allow_mccs_airplane',
        :'allow_mccs_car_rental' => :'allow_mccs_car_rental',
        :'allow_mccs_travel' => :'allow_mccs_travel',
        :'allow_mccs_food' => :'allow_mccs_food',
        :'allow_mccs_courier' => :'allow_mccs_courier',
        :'allow_mccs_car_pound' => :'allow_mccs_car_pound',
        :'allow_mccs_car_repairs' => :'allow_mccs_car_repairs',
        :'allow_mccs_hardware' => :'allow_mccs_hardware',
        :'allow_mccs_advertising' => :'allow_mccs_advertising',
        :'allow_mccs_online_subscription' => :'allow_mccs_online_subscription',
        :'allow_mccs_misc' => :'allow_mccs_misc',
    ...
    def self.swagger_types
      {
        ...
        :'allow_mccs_car_park' => :'BOOLEAN',
        :'allow_mccs_taxi' => :'BOOLEAN',
        :'allow_mccs_medical' => :'BOOLEAN',
        :'allow_mccs_airplane' => :'BOOLEAN',
        :'allow_mccs_car_rental' => :'BOOLEAN',
        :'allow_mccs_travel' => :'BOOLEAN',
        :'allow_mccs_food' => :'BOOLEAN',
        :'allow_mccs_courier' => :'BOOLEAN',
        :'allow_mccs_car_pound' => :'BOOLEAN',
        :'allow_mccs_car_repairs' => :'BOOLEAN',
        :'allow_mccs_hardware' => :'BOOLEAN',
        :'allow_mccs_advertising' => :'BOOLEAN',
        :'allow_mccs_online_subscription' => :'BOOLEAN',
        :'allow_mccs_misc' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allow_mccs_car_park')
        self.allow_mccs_car_park = attributes[:'allow_mccs_car_park']
      end
      ...
      if attributes.has_key?(:'allow_mccs_medical')
        self.allow_mccs_medical = attributes[:'allow_mccs_medical']
      end
      ...
      if attributes.has_key?(:'allow_mccs_car_rental')
        self.allow_mccs_car_rental = attributes[:'allow_mccs_car_rental']
      end

      if attributes.has_key?(:'allow_mccs_travel')
        self.allow_mccs_travel = attributes[:'allow_mccs_travel']
      end

      if attributes.has_key?(:'allow_mccs_food')
        self.allow_mccs_food = attributes[:'allow_mccs_food']
      end
      ...
      if attributes.has_key?(:'allow_mccs_car_pound')
        self.allow_mccs_car_pound = attributes[:'allow_mccs_car_pound']
      end

      if attributes.has_key?(:'allow_mccs_car_repairs')
        self.allow_mccs_car_repairs = attributes[:'allow_mccs_car_repairs']
      end

      if attributes.has_key?(:'allow_mccs_hardware')
        self.allow_mccs_hardware = attributes[:'allow_mccs_hardware']
      end

      if attributes.has_key?(:'allow_mccs_advertising')
        self.allow_mccs_advertising = attributes[:'allow_mccs_advertising']
      end

      if attributes.has_key?(:'allow_mccs_online_subscription')
        self.allow_mccs_online_subscription = attributes[:'allow_mccs_online_subscription']
      end

      if attributes.has_key?(:'allow_mccs_misc')
        self.allow_mccs_misc = attributes[:'allow_mccs_misc']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          allow_mccs_car_park == o.allow_mccs_car_park &&
          allow_mccs_taxi == o.allow_mccs_taxi &&
          allow_mccs_medical == o.allow_mccs_medical &&
          allow_mccs_airplane == o.allow_mccs_airplane &&
          allow_mccs_car_rental == o.allow_mccs_car_rental &&
          allow_mccs_travel == o.allow_mccs_travel &&
          allow_mccs_food == o.allow_mccs_food &&
          allow_mccs_courier == o.allow_mccs_courier &&
          allow_mccs_car_pound == o.allow_mccs_car_pound &&
          allow_mccs_car_repairs == o.allow_mccs_car_repairs &&
          allow_mccs_hardware == o.allow_mccs_hardware &&
          allow_mccs_advertising == o.allow_mccs_advertising &&
          allow_mccs_online_subscription == o.allow_mccs_online_subscription &&
          allow_mccs_misc == o.allow_mccs_misc &&
