...
module Mooncard
  class PutApiV3UserProfilesUserProfile
    ...
    def hash
      [position, archived_at, direct_manager_ids, company_id, active, analytic_code, code, accounting_employee_account, accounting_charge_account, two_factor_active, role, expense_type, status, auto_check_rebilling, use_km_expenses, use_manual_expenses, phone, address, email, firstname, lastname, birthdate, locale].hash
    end
