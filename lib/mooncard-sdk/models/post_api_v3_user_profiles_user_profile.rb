...
module Mooncard
  class PostApiV3UserProfilesUserProfile
    ...
    def hash
      [position, direct_manager_ids, company_id, active, analytic_code, code, accounting_employee_account, accounting_charge_account, two_factor_active, expense_type, status, auto_check_rebilling, use_km_expenses, use_manual_expenses, email, firstname, lastname, role, phone, address, birthdate, locale].hash
    end
