...
module Mooncard
  class Account
    ...
    # Available balance for payment authorizations
    attr_accessor :balance_available

    # Real balance on the account
    attr_accessor :balance_real

    # Only present when account was closed
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'balance_real')
        self.balance_real = attributes[:'balance_real']
      end
    ...
    def hash
      [id, balance_available, balance_real, closed_at, created_at, currency, token, updated_at].hash
    end
