...
module Mooncard
  class PostApiV3CardActivationCardActivation
    ...
    def list_invalid_properties
      ...
      if @user_profile_id.nil?
        invalid_properties.push('invalid value for "user_profile_id", user_profile_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @user_profile_id.nil?
    ...
    def hash
      [digits, card_id, user_profile_id, terms].hash
    end
