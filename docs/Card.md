...
**activated_at** | **DateTime** | The card is activated by the cardholder when he receives his PIN | [optional] 
...
**allow_mccs_car_park** | **BOOLEAN** | Enables payments in car parks | [optional] 
**allow_mccs_taxi** | **BOOLEAN** | Enables payments for taxi and black car services | [optional] 
**allow_mccs_medical** | **BOOLEAN** | Enables payments for health and pharmacy | [optional] 
**allow_mccs_airplane** | **BOOLEAN** | Enables payments for plane tickets | [optional] 
**allow_mccs_car_rental** | **BOOLEAN** | Enables payments for car rentals | [optional] 
**allow_mccs_travel** | **BOOLEAN** | Enables payments in hotels | [optional] 
**allow_mccs_food** | **BOOLEAN** | Enables payments in restaurants | [optional] 
**allow_mccs_courier** | **BOOLEAN** | Enables payments for delivery services | [optional] 
**allow_mccs_car_pound** | **BOOLEAN** | Enables payments of fines and car pounds | [optional] 
**allow_mccs_car_repairs** | **BOOLEAN** | Enables payments in autoshops, towing | [optional] 
**allow_mccs_hardware** | **BOOLEAN** | Enables payments for hardware and furnitures | [optional] 
**allow_mccs_advertising** | **BOOLEAN** | Enables payments for marketing and advertising | [optional] 
**allow_mccs_online_subscription** | **BOOLEAN** | Enables payments for subscriptions on the internet | [optional] 
**allow_mccs_misc** | **BOOLEAN** | Enables miscellaneous payments | [optional] 
...
**assigned_at** | **DateTime** | The card is assigned to a cardholder by an admin | [optional] 
**color** | **String** |  | [optional] 
**countries** | **BOOLEAN** | Enables payments in foreign countries (not France) | [optional] 
**deprecated_at** | **DateTime** | A deprecated card is definitively blocked and archived | [optional] 
